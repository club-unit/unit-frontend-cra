  ...
  return (
    <div className="flex flex-col gap-2">
      <Card title="유니트 회칙">
        ...
        <p>
          <br />
          제1조 (회원자격): 본회의 회원은 서울, 경인지역 대학에 재(휴)학 중이거나 졸업한자로서
          ...
          따르지 않는 때<br />- 회비 미납한 때<br />- 회원 간의 정보제공과 친목도모 등에 응하지
          않거나 불성실한 때<br />- 본회의 목적에 위배되거나 명예를 훼손하는 행위를 한 때<br />-
          본회의 활동에 있어 타 회원들이 이질감이 들도록 그룹을 만든 때<br />- 하극상을 행한 때
          <br />- 준회원의 경우 총단행사 2회, 정회원의 경우 총단행사 1회를 참가하지 않은 때
          <br />- 지구대 멤버쉽 출결회칙에 미달했을 때<br />- 휴동 시 결정한 복귀시기를 어길 때
          <br />
          <br />
          (특칙) : 전 회원은 항시 유니트 홈페이지(unit.kr)의 각 지구대 공지사항을 확인하고 숙지하여
          이에 따라 행한다. 회원의 과실 및 고의로 공지사항을 확인하지 않아 입은 손해 및 피해는
          본회의 책임이 없는 것으로 간주한다.
          <br />
          <br />
          제3조 (회원명칭): 회원명칭은 신입회원, 준회원, 정회원, 우수회원, OB회원으로 나눈다.
          <br />
          <br />
          ...
          <br />
          3. 정 회 원 : 휴동(군대, 연수, 학교휴학 등) 제외 5학기 이상 활동한 회원
          <br />
          (팀장이 명단을 올린 후 총단 측에서 검토함)
          <br />
          4. 우수회원 : 9학기 이상 활동하였으나 졸업을 하지 않은 회원
          <br />
          5. OB 회원 : 9학기 이상 활동한 회원 중 졸업한 회원
          <br />
          (팀장이 명단을 올린 후 총단 측에서 검토함)
          <br />
          <br />
        ...
        <p>&nbsp;</p>
        <p>
          제1조 (임원의 구성): 본회의 임원은 회장1인, 부회장, 총무부장, 기획부장, 회계부장,
          지원부장, 웹 관리자로 구성한다.
          <br />
          <br />
          제2조 (임기): 본회의 임원임기는 1년으로 한다.
          <br />
          지구대임원의 임기는 6개월 이상이며 재임이 가능하다.
          <br />
          <br />
          ...
          <br />
          2. 부회장 : 회장의 보좌하며 임원진을 관리한다.
          <br />
          3. 총 무 : 행상에 필요한 모든 인원 관련 준비와 회의록 작성 및 회원 간의 연락을 담당한다.
          <br />
          4. 기 획 : 행사에 필요한 예약업무와 일정 기획 등을 담당한다.
          <br />
          5. 회 계 : 회계 출납 업무를 담당한다.
          <br />
          6. 지 원 : 본회의 홍보 및 행사 준비 등의 임무를 총괄한다.
          <br />
          7. 웹 관리자 ; 홈페이지의 모든 사항의 관리한다.
        ...
        <p>
          ...
          임원에게 통보한다. (정기총회 = LT)
          <br />
          2. 주 회의 : 주 1회 회장의 지시 하에 총무부장의 통보로 지정된 장소에서 행하여진다.
          <br />
          3. 행사 관련 회의 : 행사 때 마다 필요 시 소집하고 장소 및 시간은 임원진에서 결정하여
          임원에게 통보한다.
          <br />
          <br />
          제2조 (회의 의사결정):
        ...
        <p>
          ...
          30,000원으로 한다.
          <br />- 본회의 지구대 운영비는 지구대별로 상이할 수 있다. - 각 지구대 팀장, 본회의 임원,
          우수회원, OB회원, 역대회장단은 회비가 없음
          <br />- 역대회장단은 패러글라이딩, 스키캠프를 제외한 모든 총단행사를 무료로 참가 할 수
          있다.
          <br />- 총단은 매월 15일까지 전월 회계내역을 공개할 의무를 가진다.
          <br />
          <br />
          제2조 (회비지출)
          <br />- 행상관련에 대한 활동 지원비
          ...
          <br />
          제4조 (회계 연도)
          <br />- 회계연도는 매년 1월1일부터 12월 31일 까지 한다.
          <br />
          <br />
          제5조 (환불 규정) : 신입 가입 비 환불 기준
          <br />- OT 전 : 전액 환불
          <br />- OT 이후 첫 멤버쉽 전 : OT비 제외한 30,000원 환불
          <br />- 첫 멤버쉽 이후 : 환불 불가
      ...
      <Card title="개인정보처리방침">
        ...
        <p>
          ...
          <br />② unit는 귀하의 개인정보보호를 매우 중요시하며,『정보통신망이용촉진 및 정보보호에
          관한 법률』상의 개인정보 보호규정 및 정보통신부가 제정한 『개인정보보호지침』을 준수하고
        ...
        <p>
          귀하께서 unit의 개인정보보호방침 또는 이용약관의 내용에 대해「동의한다」버튼 또는
          「동의하지 않는다」버튼을 클릭할 수 있는 절차를 마련하여, 「동의한다」버튼을 클릭하면
        ...
        <p>
          ...
          개인정보열람 및 정정을 하고자 할 경우에는로그인 후『회원정보수정』을 클릭하여 직접 열람
          또는 정정하거나, 개인정보관리책임자 및 담당자에게 서면, 전화 또는 E-mail로 연락하시면
          지체없이 조치하겠습니다.
          <br />② 귀하가 개인정보의 오류에 대한 정정을 요청한 경우, 정정을 완료하기 전까지 당해 개인
          정보를 이용 또는 제공하지 않습니다.
          <br />③ 잘못된 개인정보를 제3자에게 이미 제공한 경우에는 정정 처리결과를 제3자에게
